        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20 md:h-24">
            ...
            <Link href="/" className="flex items-center  group" aria-label="Payneor Home">
              ...
              <Image src="https://res.cloudinary.com/diml90c1y/image/upload/v1769384033/ChatGPT_Image_Jan_26__2026__04_32_03_AM-removebg-preview_jftkhn.png" alt="PayNeor" width={100} height={55} className="hidden sm:block h-36 w-auto" />
            </Link>
