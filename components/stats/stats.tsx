...
const stats = [
  {
    ...
    color: "from-[#1d7dd1] to-[#89e897]",
    bgColor: "bg-[#1d7dd1]/10",
    iconColor: "text-[#1d7dd1]",
  },
  {
    icon: Store,
    value: 10000,
  ...
  },
  {
    ...
    color: "from-[#89e897] to-[#1d7dd1]",
    bgColor: "bg-[#1d7dd1]/10",
    iconColor: "text-[#89e897]",
  },
]
...
export function StatsSection() {
  return (
    <section style={{ fontFamily: "var(--font-body)" }} className="relative py-24 md:py-32 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-white via-white to-white overflow-hidden">
      {/* Subtle background pattern */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none opacity-40">
        <svg className="absolute inset-0 w-full h-full" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <pattern id="stats-grid" width="32" height="32" patternUnits="userSpaceOnUse">
              <circle cx="2" cy="2" r="1" fill="#1d7dd1" opacity="0.1" />
            </pattern>
          </defs>
      ...
      {/* Gradient orbs */}
      <div className="absolute top-20 left-10 w-72 h-72 bg-[#1d7dd1]/10 rounded-full blur-3xl" />
      <div className="absolute bottom-20 right-10 w-96 h-96 bg-[#89e897]/10 rounded-full blur-3xl" />

      <div className="relative max-w-7xl mx-auto">
        {/* Header */}
        <div className="text-center mb-20">
          <div className="inline-flex items-center gap-2.5 px-5 py-2.5 rounded-full bg-white border border-gray-200 shadow-sm mb-6">
            <span className="relative flex h-2.5 w-2.5">
              <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#1d7dd1] opacity-75"></span>
              <span className="relative inline-flex rounded-full h-2.5 w-2.5 bg-[#1d7dd1]"></span>
            </span>
            <span className="text-sm font-semibold text-gray-700 uppercase tracking-wide">Trusted Worldwide</span>
          </div>
          
          <h2 className="text-4xl sm:text-5xl md:text-6xl font-bold text-gray-900 mb-5 leading-tight">
            Powering Payments{" "}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#1d7dd1] via-[#89e897] to-[#1d7dd1]">
              Across the Region
            </span>
          </h2>
        ...
        <div className="mt-20 flex flex-wrap items-center justify-center gap-6 md:gap-8">
          {badges.map((badge) => (
            <div
              key={badge.label}
              className="flex items-center gap-3 px-5 py-3 rounded-xl bg-white border border-gray-200 shadow-sm hover:shadow-md transition-all duration-200"
            >
        ...
        <div className="mt-20 text-center">
          <div className="inline-flex flex-col sm:flex-row items-center gap-3 px-8 py-5 rounded-2xl bg-gradient-to-r from-[#1d7dd1] to-[#1d7dd1] text-white shadow-lg shadow-[#1d7dd1]/20">
