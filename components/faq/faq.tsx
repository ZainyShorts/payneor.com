      ...
      <section className="relative bg-white py-20" style={{ fontFamily: "'Inter', sans-serif" }}>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16">
            {/* Badge */}
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#1d7dd1]/10 border border-[#1d7dd1]/20 mb-6">
              <Sparkles className="h-4 w-4 text-[#1d7dd1]" />
              <span className="text-sm font-semibold text-[#1d7dd1] uppercase tracking-wide">FAQ</span>
            </div>
            ...
            <p className="text-lg text-gray-600 leading-relaxed">
              ...
              <a href="#contact" className="text-[#1d7dd1] font-semibold hover:text-[#89e897] transition-colors">
          ...
          <div className="max-w-2xl mx-auto mb-12">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-4 bg-white border border-gray-300 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:border-[#1d7dd1] focus:ring-2 focus:ring-[#1d7dd1]/20 transition-all"
              />
            </div>
          </div>
              ...
              <button
                ...
                className={`px-6 py-3 rounded-lg font-semibold text-sm transition-all ${
                  activeCategory === category.id
                    ? "bg-[#1d7dd1] text-white shadow-md"
                    : "bg-white text-gray-700 border border-gray-200 hover:border-[#1d7dd1] hover:text-[#1d7dd1]"
                }`}
              >
          ...
          <div className="grid lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-4 hidden lg:block">
              <div className="sticky top-8 bg-white border border-gray-200 rounded-2xl p-8 shadow-sm">
                {/* Icon */}
                <div className="w-16 h-16 rounded-xl bg-[#1d7dd1]/10 flex items-center justify-center mb-6">
                  <MessageCircleQuestion className="h-8 w-8 text-[#1d7dd1]" />
                </div>

                
                <h3 className="text-2xl cursor-pointer font-bold text-gray-900 mb-3">Still have questions?</h3>
                <p className="text-gray-600 mb-6 leading-relaxed">
                  Can't find the answer you're looking for? Our support team is here to help you 24/7.
                </p>
<Link href={'/contact'} >
                <button className="w-full cursor-pointer inline-flex items-center justify-center gap-2 px-6 py-4 rounded-xl font-semibold text-white bg-[#1d7dd1] hover:bg-[#89e897] transition-colors shadow-md">
                  Contact Support
                    ...
                    >
                      <div className="flex items-start gap-4 flex-1">
                        ...
                        <h3
                          className={`text-lg font-semibold transition-colors ${
                            openItems.includes(index) ? "text-gray-900" : "text-gray-700"
                          }`}
                        >
                          {faq.question}
                        </h3>
                      ...
                      <div
                        className={`flex-shrink-0 w-8 h-8 rounded-lg flex items-center justify-center transition-all ${
                          openItems.includes(index)
                            ? "bg-[#1d7dd1]/10 text-[#1d7dd1] rotate-180"
          ...
          {/* Mobile CTA Card */}
          <div className="lg:hidden mt-12 bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
            <div className="flex items-center gap-4 mb-4">
              <div className="w-12 h-12 rounded-xl bg-[#1d7dd1]/10 flex items-center justify-center">
                <MessageCircleQuestion className="h-6 w-6 text-[#1d7dd1]" />
              </div>
              <div>
            ...
            <button className="w-full inline-flex items-center justify-center gap-2 px-6 py-4 rounded-xl font-semibold text-white bg-[#1d7dd1] hover:bg-[#89e897] transition-colors">
              Contact Support
              <ArrowRight className="h-5 w-5" />
            </button>
          </div>
