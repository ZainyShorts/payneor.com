...
export function Footer() {
  ...
  const footerLinks = {
    ...
    products: [
      ...
      { label: "POS Solutions", href: "/products/pos" },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="space-y-4">
              <a
                href="mailto:contact@neopay.com"
      ...
      <div className="border-t border-border">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            {/* Copyright */}
            <p className="text-sm text-muted-foreground">© {currentYear} NeoPay. All rights reserved.</p>
            ...
            <div className="flex items-center gap-3">
              <a
                href="https://twitter.com/neopay"
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 rounded-full bg-muted flex items-center justify-center text-muted-foreground hover:bg-orange-50 hover:text-orange-500 transition-colors"
                aria-label="Twitter"
              >
              ...
              <a
                href="https://linkedin.com/company/neopay"
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 rounded-full bg-muted flex items-center justify-center text-muted-foreground hover:bg-orange-50 hover:text-orange-500 transition-colors"
                aria-label="LinkedIn"
              ...
              <a
                href="https://instagram.com/neopay"
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 rounded-full bg-muted flex items-center justify-center text-muted-foreground hover:bg-orange-50 hover:text-orange-500 transition-colors"
